...
urlpatterns = [
    ...
    path('company_name_suggestion_job',company_name_suggestion_job,name='company_name_suggestion_job'),
    
    # path('print_job/<int:job_id>/',job_detail_print,name='job_detail_print'),
    path('company_name_suggestion',company_name_suggestion,name='company_name_suggestion'),
